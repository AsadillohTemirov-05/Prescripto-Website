    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row gap-4 '>
        ...
        <div className='flex-1 border border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
          ...
          {/* Doctor About */}
          <div>
            <p className='flex items-center gap-1 font-medium text-gray-900 mt-3'>About <img src={assets.info_icon} alt="" /></p>
          ...
          <div className='sm:ml-72 mt-4 font-medium  text-gray-700'>
            ...
            <div className='flex items-center gap-3 w-full  overflow-x-scroll mt-4'>
              {docSlots.length && docSlots[slotIndex].map((item,index)=>(
                ...
                <button className='bg bg-primary text-white text-sm px-14 font-light py-3 mt-5 border rounded-full '>Book an Appointment </button>
          </div>
